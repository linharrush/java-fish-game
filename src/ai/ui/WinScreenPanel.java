...
public class WinScreenPanel extends JPanel {
    ...
    public WinScreenPanel(MainRouter mainRouter) {
        ...
        JLabel winLabel = new JLabel(loadWinIcon(), SwingConstants.CENTER);
        if (winLabel.getIcon() == null) {
            winLabel.setText("WIN");
            winLabel.setForeground(new Color(255, 220, 80));
            winLabel.setFont(new Font("SansSerif", Font.BOLD, 96));
        }
    ...
    private ImageIcon loadWinIcon() {
        java.net.URL url = getClass().getResource("images/WIN.png");
        if (url == null) {
            return null;
        }
